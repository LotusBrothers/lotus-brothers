...
const fallbackProjects = [
  {
    ...
    description: "A collection of 120 residences perched above the Austin skyline, where floor-to-ceiling glass, rooftop gardens, and biophilic interiors create a sanctuary above the city.",
    beds: "2–4",
    status: "in_progress",
  },
  {
    ...
    description: "24 single-family villas arranged around private courtyards and shared meditation gardens. Each home is designed to disappear into its landscape.",
    beds: "3–5",
    status: "completed",
  },
  {
    ...
    description: "A desert retreat that blends rammed-earth construction with contemporary architecture. Infinity pool, spa, and outdoor living spaces flow seamlessly together.",
    beds: "4–6",
    status: "in_progress",
  },
];
